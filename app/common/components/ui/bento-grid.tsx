...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      "transform-gpu bg-primary border-2 border-accent/30 [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]",
      className,
    )}
    {...props}
  >
    ...
    <div className="pointer-events-none absolute inset-0 transform-gpu transition-all duration-300 group-hover:bg-background/10" />
  </div>
);
